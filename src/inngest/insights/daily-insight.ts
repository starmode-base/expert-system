...
/**
 * Generate insights for each user based on takeaways created in the last 3 days.
 * Manually triggered only — no cron schedule.
 */
const trigger = { event: "scheduler.daily-insight.manual" } as const;
